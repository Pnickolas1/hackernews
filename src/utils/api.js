...
const APP_HEADER = { headers: { 'Authorization': 'LateRdPick', 'Content-Type': 'application/json'}}
...
export function incrementPostVote(postId){
  return axios.put(API_URL + "/posts/" + postId, {option: "upVote"}, APP_HEADER)
}

export function decrementPostVote(postId){
  return axios.put(API_URL + "/posts/" + postId, {optionL: "downVote"}, APP_HEADER)
}

export function deletePost(postId){
  return axios.put(API_URL + "/posts/" + postId, APP_HEADER)
}
...
export function createComment(comment){
  return axios.get(API_URL + '/comments', comment,APP_HEADER)
}
