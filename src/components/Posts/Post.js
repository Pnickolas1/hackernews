                ...
                <div className="col-md-12">
                  ...
                  <form onSubmit={this.savePost}>
                    <div className="form-group">
                      ...
                      onChange={this.handleChange} value={this.state.editPost.title} required={true}/>
                    </div>
                    <div className="form-group">
                      <label>Body</label>
...
function mapDispatchToProps(dispatch){
  return {
    actions: bindActionCreators({...postActions, ...commentActions,...categoryActions, }, dispatch )}
  }
