            ...
            <div className="cold-md-2">
              ...
              <div className="col-md-4 ml-md-auto">
                ...
                <select className="form-control sort-by-selection" value={this.state.sortBy} onChange={this.changeSortMethod}>
                  ...
                  <option value="timestamp">TimeStamop</option>
                </select>
              </div>
            </div>
                ...
                <form onSubmit={this.createComment} className="margin-top-10">
                  <div className="row">
                    <div className="col-md-6">
                      <input type="text" required name="comment" placeholder="Enter you comments" className="form-control" />                  
                    </div>
                  <div className="col-md-6">
                    ...
                    <div className="col-md-12">
                      ...
                      <form onSubmit={this.saveComment}>
                        <div className="form-group">
                          <label>Body</label>
                          <textarea className="form-control" id="body" placeholder="what's on your mind?" onChange={this.handleChange} value={this.state.editComment.body} required={true} />                      
                        </div>
...
function mapStateToProps({comments}){
  return {
    comments: helpers.sort(comments)
  }
}
